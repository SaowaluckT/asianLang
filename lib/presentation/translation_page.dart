...
//     try {
//       // Fetch translation
//       final String translatedText = await TranslateService.translate(searchWord, translateTo);
//       final translationsWithPronunciation = await TranslateService.loadTranslations();
//       _searchResultPinyin = await TranslateService.translateToPinyin(
//         searchWord,
//       );
//
...
//         final String englishTranslation = await TranslateService.translateToEnglish(searchWord);
//         final String? englishPronunciation = translationsWithPronunciation[englishTranslation];
...
//       _listWordHistory = result.map((json) => KeywordModel.fromJson(json)).toList();
//       setState(() {});
//     }
//   }
//
...
//
//     final result = await _notebookDB?.query(NotebookFields.tableBooks,);
//     print("_initNotebookDB =========> table notebook result: $result");
//
//     if (result?.isEmpty ?? true) {
//       await _notebookDB?.insert(NotebookFields.tableBooks, notebook.toMap(), conflictAlgorithm: ConflictAlgorithm.replace,);
//     } else {
...
//           return LayoutBuilder(builder: (BuildContext contextLayout, BoxConstraints constraints) {
...
//                         physics: (_listNotebook.length < 4) ? const NeverScrollableScrollPhysics() : null,
//                         itemBuilder: (ct, i) {
//                           return Container(
...
//                               onPressed: () {
//                                 _insertToNotebookDB(context, notebookName: _listNotebook[i].name!);
//                               },
//                               child: Row(
//                                 children: [
//                                   Text(
...
//                               _fetchData();
//                             },
//                             label: AppConstants.languages[selectedLanguage] ?? ''),
//                         IconButton(
...
//                   ),
//                   Visibility(
//                     visible: (_searchResult?.isNotEmpty ?? false) && _searchFocusNode.hasFocus,
//                     /* History */
...
//                                         children: [
//                                           TextSpan(
//                                             text: _listWordHistory[index].word ?? "$index",
//                                           ),
//                                           const TextSpan(text: "    "),
//                                           TextSpan(
//                                             text: _listWordHistory[index].translated ?? "",
//                                             style: const TextStyle(
//                                               fontSize: 16,
...
//                                       ),
//                                       onPressed: () {
//                                         FlutterClipboard.copy('${_listWordHistory[index].word} (${_listWordHistory[index].translated})').then((value) {
...
//                                     child: Text(
//                                       (_searchResultPinyin?.isNotEmpty ?? false) ? '($_searchResultPinyin)' : '',
//                                       style: const TextStyle(
//                                         fontSize: 16,
//                                         color: Colors.black38,
//                                       ),
...
//                                 ),
//                                 onPressed: () {
//                                   FlutterClipboard.copy('$_searchResult').then((value) {
//                                     ScaffoldMessenger.of(context).showSnackBar(
//                                       SnackBar(content: Text('Copied "$_searchResult" to clipboard')),
//                                     );
//                                   });
//                                 },
//                               ),
...
//   }
//
//   Widget _selectionLanguageWidget({required Function(String value) onSelectedFunction, required String label}) {
